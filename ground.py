...
class World:
    ...
    def create_world(self):
        self.edges()
        self.add_bioms()
        self.add_item(self.colors['mountains'], 0.6, octaves=2, seed_offset=5000)
        self.add_item(self.colors['water'], 0.66, octaves=2, seed_offset=1000)
        self.add_item(self.colors['copper'], 0.65, octaves=2, seed_offset=255)
        self.add_item(self.colors['coal'], 0.656, octaves=1, seed_offset=3100)
        self.add_item(self.colors['iron'], 0.66, octaves=2, seed_offset=2500)
        self.add_item(self.colors['silver'], 0.66, octaves=2, seed_offset=5000)
        self.add_item(self.colors['lithium'], 0.67, octaves=2, seed_offset=3500)
        self.add_item(self.colors['titanium'], 0.67, octaves=1, seed_offset=4500)
        self.add_item(self.colors['uranium'], 0.69, octaves=4, seed_offset=500)
        self.checking()
